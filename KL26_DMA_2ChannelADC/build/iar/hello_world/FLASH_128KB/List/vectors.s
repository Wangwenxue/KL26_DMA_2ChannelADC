///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.40.3.8902/W32 for ARM       04/Feb/2016  09:22:46
...
//        dma\KL26_DMA_2ChannelADC\src\cpu\vectors.c
//    Command line =  
//        "C:\Users\b51443\Desktop\jicheng
//        dma\KL26_DMA_2ChannelADC\src\cpu\vectors.c" -D IAR -D FREEDOM -lCN
//        "C:\Users\b51443\Desktop\jicheng
...
//    List file    =  
//        C:\Users\b51443\Desktop\jicheng
//        dma\KL26_DMA_2ChannelADC\build\iar\hello_world\FLASH_128KB\List\vectors.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\b51443\Desktop\jicheng dma\KL26_DMA_2ChannelADC\src\cpu\vectors.c
//    1 /******************************************************************************
//    2 * File:    vectors.c
//    3 *
...
__vector_table:
        ...
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
        DC32 default_isr, default_isr, default_isr, DMA1_IRQHandler
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
...
//  325    PORTA_PCR4 |= PORT_PCR_ISF_MASK;    
        LDR      R0,??DataTable2_2  ;; 0x40049010
        LDR      R0,[R0, #+0]
        MOVS     R1,#+128
...
//  368     printf ("BFAR = %x\n", (*((volatile unsigned long *)(0xE000ED38))));
        LDR      R0,??DataTable2_13  ;; 0xe000ed38
        LDR      R1,[R0, #+0]
        LDR      R0,??DataTable2_14
        BL       printf
//  369     printf ("CFSR = %x\n", (*((volatile unsigned long *)(0xE000ED28))));
        LDR      R0,??DataTable2_15  ;; 0xe000ed28
        LDR      R1,[R0, #+0]
        LDR      R0,??DataTable2_16
        BL       printf
//  370     printf ("HFSR = %x\n", (*((volatile unsigned long *)(0xE000ED2C))));
        LDR      R0,??DataTable2_17  ;; 0xe000ed2c
        LDR      R1,[R0, #+0]
        LDR      R0,??DataTable2_18
        BL       printf
//  371     printf ("DFSR = %x\n", (*((volatile unsigned long *)(0xE000ED30))));
        LDR      R0,??DataTable2_19  ;; 0xe000ed30
        LDR      R1,[R0, #+0]
        LDR      R0,??DataTable2_20
        BL       printf
//  372     printf ("AFSR = %x\n", (*((volatile unsigned long *)(0xE000ED3C))));
        LDR      R0,??DataTable2_21  ;; 0xe000ed3c
        LDR      R1,[R0, #+0]
