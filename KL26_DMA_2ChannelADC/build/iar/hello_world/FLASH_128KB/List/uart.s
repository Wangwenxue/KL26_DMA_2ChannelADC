///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.40.3.8902/W32 for ARM       04/Feb/2016  09:22:45
...
//        dma\KL26_DMA_2ChannelADC\src\drivers\uart\uart.c
//    Command line =  
//        "C:\Users\b51443\Desktop\jicheng
//        dma\KL26_DMA_2ChannelADC\src\drivers\uart\uart.c" -D IAR -D FREEDOM
//        -lCN "C:\Users\b51443\Desktop\jicheng
...
//    List file    =  
//        C:\Users\b51443\Desktop\jicheng
//        dma\KL26_DMA_2ChannelADC\build\iar\hello_world\FLASH_128KB\List\uart.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\b51443\Desktop\jicheng dma\KL26_DMA_2ChannelADC\src\drivers\uart\uart.c
//    1 /*
//    2  * File:        uart.c
...
//  140     SIM_SCGC4 |= SIM_SCGC4_UART0_MASK;
        LDR      R0,??DataTable1_1  ;; 0x40048034
        LDR      R0,[R0, #+0]
        MOVS     R3,#+128
        LSLS     R3,R3,#+3        ;; #+1024
        ORRS     R3,R3,R0
...
//  150         reg_temp &= ~SIM_SOPT2_UART0SRC_MASK;
        MOVS     R0,R3
        LDR      R3,??DataTable1_5  ;; 0xf3ffffff
        ANDS     R3,R3,R0
